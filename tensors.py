...
def create_image(options: Options) -> torch.Tensor:
    ...
    # QUESTION
    # What is the point of this? Why was this mentioned?
    # What is meant with 'use them to separate the problem into smaller sections'?
    # The function is not even used?
